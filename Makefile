...
transfers-api:
	cd bank-flow-transfers && SERVER_PORT=$(TRANSFERS_API_PORT) BAAS_BASE_URL=$(BAAS_BASE_URL) LEDGER_EXTERNAL_SETTLEMENT_ACCOUNT_ID=$(LEDGER_EXTERNAL_SETTLEMENT_ACCOUNT_ID) ./gradlew :api:bootRun
