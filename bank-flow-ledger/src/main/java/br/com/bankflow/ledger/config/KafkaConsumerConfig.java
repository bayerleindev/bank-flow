...
public class KafkaConsumerConfig {
    ...
    ConcurrentKafkaListenerContainerFactory<String, AccountCreatedEvent>
            accountCreatedKafkaListenerContainerFactory(
                    ...
                    DefaultErrorHandler ledgerErrorHandler,
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, MovementCreatedEvent>
            movementCreatedKafkaListenerContainerFactory(
                    @Value("${spring.kafka.bootstrap-servers}") String bootstrapServers,
                    @Value("${spring.kafka.consumer.group-id}") String groupId,
                    @Value("${spring.kafka.consumer.auto-offset-reset}") String autoOffsetReset,
                    DefaultErrorHandler ledgerErrorHandler,
                    @Value("${app.kafka.consumer.movement-created.concurrency}") int concurrency,
                    @Value("${app.kafka.consumer.max-poll-records}") String maxPollRecords) {
        ConcurrentKafkaListenerContainerFactory<String, MovementCreatedEvent> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(
                consumerFactory(
                        bootstrapServers,
    ...
    private void customizeContainer(ConcurrentMessageListenerContainer<String, ?> container) {
        container
